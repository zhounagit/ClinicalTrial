...
public class countParticipant {
    ...
    public static void main(String[] args) {
        ...
        Document query1 = new Document("clinical_study.id_info.nct_id","NCT01617434");
